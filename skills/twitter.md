...
**If no topic:**
- Check `./data/<active>/ideas/` for recent ideas
...
Append to `./data/<active>/posts/YYYY-MM-DD.md`:
...
All fetched data saved to `./data/<active>/research/`:
